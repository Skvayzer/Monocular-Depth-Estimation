...
```
cd existing_repo
git remote add origin https://gitlab.com/edgevision/depth-estimation.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/edgevision/depth-estimation/-/settings/integrations)
